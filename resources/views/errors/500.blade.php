...
@section('title', __('messages.errors.server_h1'))
...
@section('content')
    <div class="max-w-md mx-auto mt-20 mb-10 px-4 text-center">
        ...
        <h1 class="font-display text-3xl sm:text-4xl font-bold m-0">{{ __('messages.errors.server_h1') }}</h1>
        <p class="text-dp-muted mt-3">{{ __('messages.errors.server_lead') }}</p>
