...
return [
    ...
    */
    'reserved_slugs' => [
        ...
        'kontakt', 'ksef', 'lista-prezentow-na-urodziny', 'lista-prezentow-slubnych',
        'locale', 'login', 'logout', 'master', 'me', 'mobile',
        'new', 'oauth', 'og', 'pakiety', 'panel', 'password', 'pay', 'payment',
        'payments', 'payu', 'pl', 'en', 'plan', 'pliki', 'pomoc',
        'polityka-prywatnosci', 'prezent-na-rocznice', 'pricing', 'private', 'profile', 'public',
        'r', 'rabat', 'regulamin', 'register', 'rejestracja', 'rodo', 'rsvp',
        'settings', 'shop', 'sitemap.xml', 'sklep', 'static', 'storage', 'support',
